...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void DartControl_Update_m3C500D87AF6AF4845097265C14F73EA371EB5D6F (DartControl_tAA0113ADC0E9AE17F222745C6E996DB03C38AEB5* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		NullCheck(L_12);
		bool L_13;
		L_13 = Component_CompareTag_mE6F8897E84F12DF12D302FFC4D58204D51096FC5(L_12, _stringLiteral776B474499536D4591AF67346D843A4926BEFA92, NULL);
		if (!L_13)
		{
			goto IL_00b7;
		}
	}
	{
		...
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_15 = __this->___DartTemp_9;
		NullCheck(L_15);
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_16;
		L_16 = GameObject_get_transform_m0BC10ADFA1632166AE5544BDF9038A2650C2AE56(L_15, NULL);
		ARSessionOrigin_tE7B28A1A19500BCC02711397A19E330425830BC3* L_17 = __this->___ARSession_6;
		NullCheck(L_17);
		...
		NullCheck(L_19);
		ThrowDart_tBD76EC3C8276DAB4759F47416774A4F305A92CC5* L_20;
		L_20 = GameObject_GetComponent_TisThrowDart_tBD76EC3C8276DAB4759F47416774A4F305A92CC5_mBD2BD9528F654B04F8D5CB45596FF5AA6DCEAAFD(L_19, GameObject_GetComponent_TisThrowDart_tBD76EC3C8276DAB4759F47416774A4F305A92CC5_mBD2BD9528F654B04F8D5CB45596FF5AA6DCEAAFD_RuntimeMethod_var);
		// currentDartScript.isForceOK = true;
		NullCheck(L_20);
		L_20->___isForceOK_6 = (bool)1;
		// DartsInit();
...
IL_00b7:
	{
		// if (isDBSearched)
		bool L_21 = __this->___isDBSearched_11;
		if (!L_21)
		{
			goto IL_0102;
		}
	}
	{
		...
		Transform_tB27202C6F4E36D225EE28A13E4D662BF99785DB1* L_22 = __this->___db_8;
		NullCheck(L_22);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_23;
		L_23 = Transform_get_position_m69CD5FA214FDAE7BB701552943674846C220FDE1(L_22, NULL);
		GameObject_t76FEDD663AB33C991A9C9A23129337651094216F* L_24 = __this->___ARCam_7;
		NullCheck(L_24);
		...
		__this->___dist_12 = L_27;
		// text_dist.text = dist.ToString().Substring(0, 3);
		TMP_Text_tE8D677872D43AD4B2AAF0D6101692A17D0B251A9* L_28 = __this->___text_dist_14;
		float* L_29 = (&__this->___dist_12);
		String_t* L_30;
		L_30 = Single_ToString_mE282EDA9CA4F7DF88432D807732837A629D04972(L_29, NULL);
		NullCheck(L_30);
		String_t* L_31;
		L_31 = String_Substring_mB1D94F47935D22E130FF2C01DBB6A4135FBB76CE(L_30, 0, 3, NULL);
		NullCheck(L_28);
...
IL_0102:
	{
		// if (timer > waitTime)
		float L_32 = __this->___timer_16;
		float L_33 = __this->___waitTime_18;
	...
	}
	{
		...
		float L_34 = __this->___frames_17;
		float L_35 = __this->___timer_16;
		__this->___framespersec_13 = ((float)(L_34/L_35));
		// timer -= waitTime;
		float L_36 = __this->___timer_16;
		float L_37 = __this->___waitTime_18;
		__this->___timer_16 = ((float)il2cpp_codegen_subtract(L_36, L_37));
		// frames = 0.0f;
...
IL_0141:
	{
		...
		TMP_Text_tE8D677872D43AD4B2AAF0D6101692A17D0B251A9* L_38 = __this->___fps_15;
		float* L_39 = (&__this->___framespersec_13);
		String_t* L_40;
